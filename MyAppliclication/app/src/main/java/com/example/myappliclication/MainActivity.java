...
public class MainActivity extends AppCompatActivity {
    ...
    private void setIntent() {
        ...
        buttonFirst.setOnClickListener(v -> {
            Intent intent = new Intent(this, com.example.myappliclication.FirstActivity.class);
            startActivity(intent);
        });

        buttonHallo.setOnClickListener(v -> {
            Intent intent = new Intent(this, com.example.myappliclication.HalloActivity.class);
            startActivity(intent);
        });

        buttonFibo.setOnClickListener(v -> {
            Intent intent = new Intent(this, fibanacci.class);
            startActivity(intent);
        });
